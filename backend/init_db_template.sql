...
('CPSC 331 - Data Structures', 'An introduction to algorithm analysis, recursion, data structures, and their implementations.'),
('MATH 271 - Discrete Mathematics', 'Introduction to sets, relations, logic, and methods of proof.'),
('CPSC 355 - Computing Machinery', 'Computer architecture and machine-level programming.'),
('PHIL 279 - Logic I', 'Introduction to deductive logic.');
