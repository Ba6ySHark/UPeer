...
const CourseList = () => {
  ...
  const handleCreateCourse = async (e) => {
    ...
    try {
      const newCourse = await courseService.createCourse(newCourseName, newCourseDescription);
            ...
            <form onSubmit={handleCreateCourse} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full px-4 py-3 shadow-sm focus:ring-primary focus:border-primary sm:text-sm border-gray-300 rounded-md"
