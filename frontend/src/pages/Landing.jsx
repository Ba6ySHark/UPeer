            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 lg:px-8 xl:mt-20">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-primary">UPeer</span>
                </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              UPeer provides the tools and community to enhance your learning journey.
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Connect with Peers</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Find and connect with students in your courses to collaborate and learn together.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Share Resources</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Exchange study materials, notes, and helpful resources with your classmates.
                  </p>
                </div>
              </div>
            </div>
